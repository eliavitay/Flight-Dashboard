import { FlightDataInterface, flightTypes, RowDataFlight, Status } from "../types/interfaces";
...
export class FlightData implements FlightDataInterface{
    ...
    constructor(rowFlight: RowDataFlight){
        ...
        this.flightType = this.calculateflightTypeType(rowFlight.duration);
        this.status = getStatus(rowFlight.status);
    }


    calculateflightTypeType(duration: number): flightTypes {
